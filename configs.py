...
class Config(object):
  API_ID = int(os.environ.get("API_ID", "11249078"))
  API_HASH = os.environ.get("API_HASH", "27c900a8bac51da6d0fd91aad09ef779")
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "6310894051:AAHzfogTHyd08y7SXd5FNH3oIqydluQcfZM")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "v2filestore_mbbot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "2045030978"))
...
"""
  ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: [MB BotZ](https://telegram.me/mb_botz)
 
 I am Super noob Please Support My Hard Work.

[Donate Me](https://Razorpay.com/@mdiskblast)
"""
  HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
